...
<!-- Mirrored from code-theme.com/html/findhouses/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2023 07:58:34 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div id="wrapper">
        ...
        <header id="header-container" class="header head-tr">
                ...
                <div class="container container-header">
                    ...
                    <div class="right-side d-none d-none d-lg-none d-xl-flex sign ml-0">
                        ...
                        <div class="header-widget sign-in">
                            <div class="show-reg-form modal-open"><a href='{{ route('login') }}'
            ...
            <div class="right-side d-none d-none d-lg-none d-xl-flex sign ml-0">
                <!-- Header Widget -->
                <div class="header-widget sign-in">
                    <div class=""><a href="register.html">Register</a></div>
                </div>
