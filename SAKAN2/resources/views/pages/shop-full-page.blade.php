...
<!-- Mirrored from code-theme.com/html/findhouses/shop-full-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2023 08:00:24 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div id="wrapper">
        ...
        <section class="blog blog-section blog-pots">
            <div class="container">
                ...
                <div class="news-wrap">
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-xs-12 news-item">
                            <a href="#">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-xs-12 news-item">
                            <a href="#">
                                <img src="images/shop/shop-7.jpg" alt="">
                            </a>
                            <div class="blog-info">
                                <h3 class="text-center">Product shop</h3>
                                <ul class="starts text-center">
                        ...
                        <div class="col-lg-4 col-md-12 col-xs-12 news-item">
                            <a href="#">
                                <img src="images/shop/shop-8.jpg" alt="">
                            </a>
                            <div class="blog-info">
                                <h3 class="text-center">Product shop</h3>
                                <ul class="starts text-center">
                        ...
                        <div class="col-lg-4 col-md-12 col-xs-12 no-mb news-item">
                            <a href="#">
                                <img src="images/shop/shop-9.jpg" alt="">
                            </a>
                            <div class="blog-info">
                                <h3 class="text-center">Product shop</h3>
                                <ul class="starts text-center">
...
<!-- Mirrored from code-theme.com/html/findhouses/shop-full-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2023 08:00:25 GMT -->
</html>
