...
<!-- Mirrored from code-theme.com/html/findhouses/favorited-listings.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2023 08:00:27 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <div class="user-profile-box mb-0">
                            ...
                            <div class="detail clearfix">
                                <ul class="mb-0">
                                    ...
                                    <!-- <li>
                                        <a class="active" href="favorited-listings-customer.html">
                                            <i class="fa fa-heart" aria-hidden="true"></i>Favorited Properties
                                        </a>
                                    </li> -->
                                    <li >
                                        <a href="user_Bookings.html" class="active">
                                            <i class="fa fa-lock"></i>My Bookings
                                        </a>
                                    </li>
                                    <!-- <li>
                                        <a href="payment_customer.html">
                                    ...
                                    <li>
                                        <a href="chang_password_customer.html">
