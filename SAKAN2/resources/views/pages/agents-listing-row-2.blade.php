...
<!-- Mirrored from code-theme.com/html/findhouses/agents-listing-row-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2023 08:00:18 GMT -->
<head>
    <meta charset="UTF-8">
                ...
                <div class="row">
                        ...
                        <div class="agent agent-row shadow-hover">
                            ...
                            <div class="agent-content">
                                <div class="agent-details">
                                    <h4><a href="agent-details.html">CARLS JHONS</a></h4>
                    ...
                    <div class="col-lg-12 agent-mb">
                        <div class="agent agent-row shadow-hover">
                            ...
                            <div class="agent-content">
                                <div class="agent-details">
                                    <h4><a href="agent-details.html">MARK WEB</a></h4>
                                    <p><i class="fa fa-tag icon"></i>Selling Agent</p>
                    ...
                    <div class="col-lg-12 agent-mb">
                        <div class="agent agent-row shadow-hover">
                            ...
                            <div class="agent-content">
                                <div class="agent-details">
                                    <h4><a href="agent-details.html">KATY GRACE</a></h4>
                                    <p><i class="fa fa-tag icon"></i>Selling Agent</p>
