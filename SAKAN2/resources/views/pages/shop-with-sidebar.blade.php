...
<!-- Mirrored from code-theme.com/html/findhouses/shop-with-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2023 08:00:22 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="inner-pages shop hd-white">
    <!-- Wrapper -->
    <div id="wrapper">
                        ...
                        <div class="detail-wrapper-body">
                            <div class="listing-title-bar">
                                <div class="text-heading text-left">
                                    <p><a href="index.html">Home </a> &nbsp;/&nbsp; <span>Shop List</span></p>
                                </div>
                                <h3>Shop List</h3>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-12 col-xs-12">
                        ...
                        <div class="row space2 port">
                            ...
                            <div class="col-md-6 col-xs-12 news-item">
                                <a href="#">
                                    <img src="images/shop/shop-4.jpg" alt="">
                                </a>
                                <div class="blog-info">
                                    <h3 class="text-center">Product shop</h3>
                                    <ul class="starts text-center">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xs-12 no-mb wpt-2 news-item">
                                <a href="#">
                                    <img src="images/shop/shop-5.jpg" alt="">
                                </a>
                                <div class="blog-info">
                                    <h3 class="text-center">Product shop</h3>
                                    <ul class="starts text-center">
                            ...
                            <div class="col-md-6 col-xs-12 no-mb wpt-2 news-item">
                                <a href="#">
                                    <img src="images/shop/shop-6.jpg" alt="">
                                </a>
                                <div class="blog-info bl">
                                    <h3 class="text-center">Product shop</h3>
                                    <ul class="starts text-center">
...
<!-- Mirrored from code-theme.com/html/findhouses/shop-with-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2023 08:00:24 GMT -->
</html>
