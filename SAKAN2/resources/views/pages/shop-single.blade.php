...
<!-- Mirrored from code-theme.com/html/findhouses/shop-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2023 08:00:25 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div id="wrapper">
        ...
        <section class="single-proper blog details">
            <div class="container">
                                        ...
                                        <div class="single-portfolio">
                                            <div class="portfolio-img">
                                                <div class="popup-images">
                                                    <a class="popup-img" href="images/shop/shop-1.jpg"><img class="img-fluid w100" src="images/shop/shop-1.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 single-p-info shop">
                                        <h2 class="mb-3">Product Shop</h2>
                                        ...
                                        <p class="mt-1 mb-4">3 Customer Review</p>
                                        <p class="product-old-price text-left">$69.97</p>
                                        <p class="recent-price text-left">$49.97</p>
                                        <a class="btn1 btn-sm" href="#"><i class="fa fa-shopping-cart mr-2"></i>Add To Cart</a>
                                        <div class="text-leftr">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-2 thumax-2">
                                        <div class="single-portfolio thumax">
                                            <div class="portfolio-img">
                                                <div class="popup-images">
                                                    <a class="popup-img" href="images/shop/shop-2.jpg"><img class="img-fluid w100" src="images/shop/shop-2.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2 thumax-2">
                                        <div class="single-portfolio thumax">
                                            <div class="portfolio-img">
                                                <div class="popup-images">
                                                    <a class="popup-img" href="images/shop/shop-3.jpg"><img class="img-fluid w100" src="images/shop/shop-3.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="single-portfolio thumax">
                                            <div class="portfolio-img">
                                                <div class="popup-images">
                                                    <a class="popup-img" href="images/shop/shop-4.jpg"><img class="img-fluid w100" src="images/shop/shop-4.jpg" alt=""></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <ul class="col-12 commented pl-0">
                                    <li class="comm-inf">
                                        ...
                                        <div class="col-md-10 comments-info">
                                            ...
                                            <div class="rest"><img src="images/shop/shop-1.jpg" class="img-fluid" alt=""></div>
                                        </div>
                                    </li>
                                ...
                                <ul class="col-12 commented mb-0 pl-0">
                                    <li class="comm-inf">
                                        ...
                                        <div class="col-md-10 comments-info">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras aliquam, quam congue dictum luctus, lacus magna congue ante, in finibus dui sapien eu dolor. Integer tincidunt suscipit erat, nec laoreet ipsum vestibulum sed.</p>
                                            <div class="resti">
                                                <div class="rest"><img src="images/shop/shop-9.jpg" class="img-fluid" alt=""></div>
                                                <div class="rest"><img src="images/shop/shop-8.jpg" class="img-fluid" alt=""></div>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <aside class="col-lg-3 col-md-12">
                        <div class="widget">
                            ...
                            <div class="recent-post pt-5">
                                <h5 class="font-weight-bold mb-4">Best Sellers</h5>
                                <div class="recent-main">
                                    <div class="recent-img">
                                        <a href="blog-details.html"><img src="images/shop/shop-1.jpg" alt=""></a>
                                    </div>
                                    <div class="info-img">
                                        <a href="blog-details.html"><h6>Product Shop</h6></a>
                                        <p>$49.97</p>
                                    </div>
                                </div>
                                <div class="recent-main my-4">
                                    <div class="recent-img">
                                        <a href="blog-details.html"><img src="images/shop/shop-2.jpg" alt=""></a>
                                    </div>
                                    <div class="info-img">
                                        <a href="blog-details.html"><h6>Product Shop</h6></a>
                                        <p>$49.97</p>
                                ...
                                <div class="recent-main">
                                    <div class="recent-img">
                                        <a href="blog-details.html"><img src="images/shop/shop-5.jpg" alt=""></a>
                                    </div>
                                    <div class="info-img">
                                        <a href="blog-details.html"><h6>Product Shop</h6></a>
                                        <p>$49.97</p>
                ...
                <section class="similar-property recently portfolio bshd p-0 bg-white-inner shop">
                    <div class="container">
                        <h5>Related Products</h5>
                        <div class="row portfolio-items blog">
                            <div class="item col-lg-4 col-md-6 col-xs-12 landscapes">
                                <a href="#">
                                    <img src="images/shop/shop-1.jpg" alt="">
                                </a>
                                <div class="blog-info">
                                    ...
                                    <p class="product-old-price text-center">$69.97</p>
                                    <p class="recent-price text-center">$49.97</p>
                                    <div class="text-center">
                                        <a class="btn1 btn-sm" href="#"><i class="fa fa-shopping-cart"></i>Add To Cart</a>
                                    </div>
                                </div>
                            </div>
                            <div class="item col-lg-4 col-md-6 col-xs-12 people">
                                <a href="#">
                                    <img src="images/shop/shop-2.jpg" alt="">
                                </a>
                                <div class="blog-info">
                                    <h3 class="text-center">Product shop</h3>
                                    <ul class="starts text-center">
                            ...
                            <div class="item col-lg-4 col-md-6 col-xs-12 people landscapes no-pb pbp-3">
                                <a href="#">
                                    <img src="images/shop/shop-3.jpg" alt="">
                                </a>
                                <div class="blog-info bl">
                                    <h3 class="text-center">Product shop</h3>
                                    <ul class="starts text-center">
                                        <li><i class="fa fa-star"></i>
                                        </li>
