...
<!-- Mirrored from code-theme.com/html/findhouses/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2023 08:00:29 GMT -->
...
<head>
   ...
   /* Vertically center */
    /* height: 100vh !important; Adjust the height as needed */
     margin-top: 10px;
        }
...
.customerDivButton ,.agentsDivButton{
    width :12%;
    margin: 0px 10px;
    color: white;
}
...
<body class="inner-pages hd-white">
    <div id="wrapper">
        ...
        <header id="header-container">
            <!-- Header -->
            <div id="header" style="background-color:rgb(230, 227, 227) !important;">
        ...
        <div class="buttons">
        <button type="button" class="btn customerDivButton" style="background-color:#FF385C">Customer</button>
        <button type="button" class="btn agentsDivButton" style="background-color:#FF385C;">Agents</button>
        </div>
        <div class="containerRegister">
         <div id="login" class="customer">
            <div class="login">
        ...
        <div id="login" class="agents" style="display: none;">
            <div class="login">
                <form autocomplete="off">
                    <div class="form-group">
                        <label>Your Name</label>
                    ...
                    <div class="form-group">
                        <label>Your ID card Image</label>
    ...
    const custmoerDivButton = document.querySelector(".customerDivButton");
    const agentsDivButton = document.querySelector(".agentsDivButton");
    const divCustomer = document.querySelector(".customer");
    const divAgents = document.querySelector(".agents");

    custmoerDivButton.addEventListener("click", function () {
        divCustomer.style.display = "block";
        divAgents.style.display = "none";
    });

    agentsDivButton.addEventListener("click", function () {
        divCustomer.style.display = "none";
        divAgents.style.display = "block";
    });
