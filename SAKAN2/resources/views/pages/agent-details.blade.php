...
<!-- Mirrored from code-theme.com/html/findhouses/agent-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2023 08:00:18 GMT -->
<head>
    <meta charset="UTF-8">
                                        ...
                                        <div class="detail-wrapper-body">
                                            <div class="listing-title-bar">
                                                <div class="text-heading text-left">
                                                    <p><a href="index.html">Home </a> &nbsp;/&nbsp; <span>Agent Single</span></p>
                                                </div>
                                                <h3>Carls Jhons</h3>
                                            </div>
                                        </div>
                                                ...
                                                <div class="homes-content">
                                                    ...
                                                    <p class="homes-address mb-3">
                                                        <a href="single-property-1.html">
                                                            <i class="fa fa-map-marker"></i><span>Est St, 77 - Central Park, NYC</span>
                                                        </a>
                                                    </p>
                                                    <!-- homes List -->
