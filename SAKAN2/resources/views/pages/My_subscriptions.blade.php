...
<!-- Mirrored from code-theme.com/html/findhouses/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Aug 2023 08:00:26 GMT -->
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 pl-0 user-dash2">
                        ...
                        <div class="dashborad-box stat bg-white">
                            ...
                            <div class="section-body">
                                <div class="row">
                                    <div class="card bg-light mb-3 col-lg-3 col-md-6 col-xs-12 dar rev mr-3" style="max-width: 18rem;">
                                        ...
                                        <div class="card bg-light mb-3 col-lg-3 col-md-6 col-xs-12 dar rev mr-3" style="max-width: 18rem;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <li> you can delete any proerty any time </li>
                                                <li> you can replace any proerty any time </li> </ul>
                                            </div>
                                        </div>
                                   
                                        <div class="card bg-light mb-3 col-lg-3 col-md-6 col-xs-12 dar rev mr-3" style="max-width: 18rem;">
                                            <div class="card-header">Evry 6 months <span style="font-size: 30px;">500$</span></div>
                                            <div class="card-body">
                                        ...
                                        <div class="card bg-light mb-3 col-lg-3 col-md-6 col-xs-12 dar rev mr-3" style="max-width: 18rem;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>Subscription starts on the first day you subscripe</li>
                                                    <li>Subscription end after 365 days</li>                                                </ul>
                                            </div>
                                        </div>
                                </div>
                            </div>
                        ...
                        <div class="dashborad-box">
                            <h4 class="title">My subsecription</h4>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="status pb-0"><span class="active">NonActive</span></td>
