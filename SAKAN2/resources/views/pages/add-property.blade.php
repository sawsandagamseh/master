                                        ...
                                        <div class="col-lg-4 col-md-12 dropdown faq-drop">
                                            <div class="form-group categories">
                                                <div class="nice-select form-control wide" tabindex="0"><span
                                                        class="current">Select subscription type</span>
                                                    <ul class="list">
                                                        <li data-value="1" class="option">weekly</li>
                                                        <li data-value="2" class="option">monthly</li>
                                                        <li data-value="3" class="option">evry 3 months</li>
                                                        <li data-value="4" class="option">evry 6 months</li>
                                                        <li data-value="2" class="option">Annually</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group categories">
                                                <div class="nice-select form-control wide" tabindex="0"><span
                                                    ...
                                                    <ul class="list">
                                                        ...
                                                        <li data-value="2" class="option">apartemnt</li>
                                                        <li data-value="3" class="option">apartment</li>
                                                        <li data-value="4" class="option">villa</li>
                            ...
                            <div class="property-form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-12 dropdown faq-drop">
                                        <div class="form-group categories">
                                            <div class="nice-select form-control wide" tabindex="0"><span
                                                    class="current">Select Bathrooms</span>
                                                <ul class="list">
                                                    <li data-value="1" class="option">1</li>
                                                    <li data-value="2" class="option">2</li>
                                                    <li data-value="1" class="option">3</li>
