                        ...
                        <div class="single-add-property">
                            ...
                            <div class="property-form-group">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-12">
                                        <p>
                                            ...
                                            <input type="text" name="first_name" placeholder="Enter Your first_name"
                                                id="first_name" value="">
                                        </p>
                                    </div>
                                    <div class="col-lg-3 col-md-12">
                                        <p>
                                            ...
                                            <input type="text" name="second_name" placeholder="Enter Your second_name"
                                                id="second_name" value="">
                                        </p>
                                    </div>
                                    <div class="col-lg-3 col-md-12">
                                        <p>
                                            <label for="third_name">Third name</label>
                                            <input type="text" name="third_name" placeholder="Enter Your third_name"
                                                id="third_name" value="">
                                        </p>
                                    </div>
                                    <div class="col-lg-3 col-md-12">
                                ...
                                <div class="row">
                                        <div class="col-md-12">
                                            <p>
                                                <label for="description">About agent</label>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-12">
                                            <p>
                                                ...
                                                <input type="number" name="id_number" placeholder="Enter Your Id number"
                                                    id="id_number" value="">
                                            </p>
                                        </div>
                                        <div class="col-lg-6 col-md-12">
                                            <p>
                                                ...
                                                <input type="file" name="id_card_image" placeholder="Enter Your id_card_image"
                                                    id="id_card_image" value="">
                                            </p>
                                        </div>
                                    </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <p class="no-mb first">
                                            ...
                                            <input type="password" name="password" placeholder="Google Maps password"
                                                id="password">
                                        </p>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="prperty-submit-button">
                                            <button type="submit">Add Admin</a></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
