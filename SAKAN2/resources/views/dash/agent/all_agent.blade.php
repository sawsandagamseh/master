            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12 col-xs-12 pl-0 user-dash2">
                    ...
                    <div class="my-properties">
                        <div class="row">
                            <div class="col-lg-9 col-md-12 col-xs-12 pl-0 user-dash2">
                                <a class="btn btn-common" href="{{ route('agent.create') }}"><i
                                        ...
                                        <td>
                                            <div class="inner">
                                                <a href="single-property-1.html">
                                                    <h2> {{ $allAgent->first_name }} {{ $allAgent->second_name }}</h2>
                                                    <h2> {{ $allAgent->last_name }}</h2>
                                                </a>

                                            </div>
                                        </td>
                                        <td>{{ $allAgent->phone }}</td>
                                       
                                        <td>{{ $allAgent->email }}</td>

                                        <td >
                                            
                                            <form method="POST" action="{{ route('agent.destroy', $allAgent->id) }}" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
