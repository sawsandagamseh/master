                       ...
                       @endsection
                        ...
                        <div class="dashborad-box mb-0">
                            ...
                            <div class="section-inforamation">
                                <form  method="post" action="{{route('dashboard_admin.update',$admin->id)}}" enctype="multipart/form-data" >
                                    @method('PUT')
                                     @csrf 
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter your First name" name="first_name" value="{{ $admin->first_name}}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter your Last name" name="second_name" value="{{ $admin->second_name}}">
                                                <span style="color:red">@error('second_name'){{ $message }} @enderror</span><br><br>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <label>Last Name</label>
                                                <input type="text" class="form-control" placeholder="Enter your Last name" name="last_name" value="{{ $admin->last_name}}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Ex: example@domain.com" name="email" value="{{ $admin->email}}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Ex: +1-800-7700-00" name="phone" value="{{ $admin->phone}}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>id</label>
                                                <input type="hidden" class="form-control" placeholder="Ex: +1-800-7700-00" name="id" value="{{ $admin->id}}">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Write about userself" name="about" value="{{ $admin->about}}">

                                                {{-- <textarea name="address" class="form-control" placeholder="Write about userself" name="about" value="{{ $admin->about}}"> {{ $admin->about}} </textarea> --}}
                                                <span style="color:red">@error('about'){{ $message }} @enderror</span><br><br>
                                            </div>
                                        </div>
